...
from rl.envs.common_wrappers import PrevActionAndReward
import numpy as np
import gym
...
class ScaledFloatFrame(gym.ObservationWrapper):
    ...
    def observation(self, observation):
        ...
        logger.warning("Moved division by 255 into the DQN encoder module", norepeat=True)
...
def make_pytorch_atari(env_id, episode_life=True, clip_rewards=True,
                       frame_stack=True, scale=False):
